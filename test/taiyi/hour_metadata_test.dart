...
void main() {
  group('TaiYi Hour Metadata Verification', () {
    late TaiYiPanCalculator calculator;
    late List<dynamic> testVectors;

    setUpAll(() {
      calculator = const TaiYiPanCalculator();
      final file = File('../test-vectors/taiyishenshu/hour_metadata.json');
    ...
    group('金镜派', () {
      test('Verify Hour metadata against jingMirror vectors', () {
    ...
    group('统宗派', () {
      test('Verify Hour metadata against tongZong vectors', () {
