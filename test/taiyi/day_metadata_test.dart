...
void main() {
  group('TaiYi Day Metadata Verification', () {
    ...
    setUpAll(() {
      ...
      final file = File('../test-vectors/taiyishenshu/day_metadata.json');
    ...
    group('金镜派', () {
      test('Verify Day metadata against jingMirror vectors', () {
    ...
    group('统宗派', () {
      test('Verify Day metadata against tongZong vectors', () {
